 ...
 * 11. 求二叉树中两个节点的最低公共祖先节点：getLastCommonParent, getLastCommonParentRec, getLastCommonParentRec2 12. 求二叉树中节点的最大距离：getMaxDistanceRec
...
public class BinaryTreeSummary {
	 ...
	 * 参考了http://stackoverflow.com/questions/11511898/converting-a-binary-search
	 ...
	 * <1返回0 （2）如果二叉树不为空并且k==1，返回1 （3）如果二叉树不为空且k>1，返回root左子树中k-1层的节点个数与root右子树k-
	 * 1层节点个数之和
	 * 
	...
	// 1. 破坏原来的树，把原来的树改成其镜像  - pre order traversal
	...
	/**
	 * 14. 判断二叉树是不是完全二叉树（递归）
	 * http://stackoverflow.com/questions/1442674/how-to-determine-whether-a-
